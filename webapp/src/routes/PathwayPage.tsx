...
export default function PathwayPage() {
  ...
  // Scroll reveal refs
  const headerRef = useScrollReveal<HTMLElement>({ threshold: 0.2, id: 'pathway-header' });
  const diagramRef = useScrollReveal<HTMLElement>({ threshold: 0.1, id: 'pathway-diagram-section' });
