              ...
              <picture>
                <source
                  srcSet={
                    ...
                    }researcher/researcher-800.jpg 800w, ` +
                    `${
                      import.meta.env.BASE_URL
                    }researcher/researcher-1600.jpg 1600w, ` +
                    `${
                      import.meta.env.BASE_URL
                    }researcher/researcher-2400.jpg 2400w, ` +
                    `${
                      import.meta.env.BASE_URL
                    }researcher/researcher-3200.jpg 3200w`
                  }
                ...
                <img
                  src={`${
                    import.meta.env.BASE_URL
                  }researcher/researcher-1600.jpg`}
      ...
      <main className={styles.main}>
        ...
        <section className={styles.grid}>
          ...
          >
            <InteractiveSurface
              as="article"
              className={`${styles.blockA} interactiveSurface`}
              hoverLift={4}
            >
          ...
          >
            <InteractiveSurface
              as="aside"
              className={`${styles.blockB} interactiveSurface`}
              hoverLift={4}
            >
              <div className={styles.quotePanel}>
                <blockquote className={styles.pullQuote}>
                  <p>
                    "The arts taught me what statistics later confirmed: people
                    make <em>meaning</em> before they make decisions."
                  </p>
                ...
                <blockquote className={styles.pullQuoteAlt}>
                  <p>
                    "Belonging is made in the quiet minutes, in the ordinary
                    grace of being remembered, of being welcomed, of being
                    regarded as worthy of <em>attention</em>."
                  </p>
                  <footer className={styles.quoteAttribution}>
                    — Research philosophy
                  </footer>
          ...
          >
            <InteractiveSurface
              as="article"
              className={`${styles.blockC} interactiveSurface`}
              hoverLift={4}
            >
              <div className={styles.blockHeader}>
          ...
          >
            <InteractiveSurface
              as="article"
              className={`${styles.blockD} interactiveSurface`}
              hoverLift={4}
            >
              <div className={styles.blockHeader}>
              ...
              <p>
                For collaboration, speaking, or questions about the work, email
                me directly.
              </p>
